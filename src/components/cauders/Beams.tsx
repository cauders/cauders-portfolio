...
import { forwardRef, useImperativeHandle, useEffect, useRef, useMemo, FC } from 'react';
...
function extendMaterial(BaseMaterial: typeof THREE.Material, cfg: ExtendMaterialConfig) {
...
const CanvasWrapper: FC<{ children: React.ReactNode }> = ({ children }) => (
...
const DirLight: FC<DirLightProps> = ({ position, color }) => {
